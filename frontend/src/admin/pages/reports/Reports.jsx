...
const Reports = () => {
  ...
  const categoryData = {
    labels: analytics.category_stats?.map(cat => cat.name) || [],
    datasets: [
      {
        data: analytics.category_stats?.map(cat => cat.count) || [],
        backgroundColor: [
          '#3b82f6',
          '#10b981',
          '#f59e0b',
  ...
  const authorsData = {
    labels: analytics.top_authors?.map(author => author.name) || [],
    datasets: [
      {
        label: 'Articles',
    ...
    <div className="reports-page">
        ...
        <div className="stats-grid">
          <div className="stat-card">
            ...
            <div className="stat-content">
              <div className="stat-value">{adminReportsService.formatNumber(analytics.total_news || 0)}</div>
          ...
          <div className="stat-card">
            ...
            <div className="stat-content">
              <div className="stat-value">{adminReportsService.formatNumber(analytics.news_period || 0)}</div>
              <div className="stat-label">Published (Period)</div>
            </div>
          </div>
          ...
          <div className="stat-card">
            ...
            <div className="stat-content">
              <div className="stat-value">{adminReportsService.formatNumber(analytics.share_stats?.reduce((sum, s) => sum + s.count, 0) || 0)}</div>
        ...
        <div className="charts-grid">
          ...
          <div className="category-list">
            {analytics.category_stats?.map((cat, index) => {
              const total = analytics.total_news || 1;
      ...
      <div className="section">
        ...
        <div className="stats-grid small">
          ...
          <div className="stat-card">
            ...
            <div className="stat-content">
              <div className="stat-value">{analytics.approved_comments || 0}</div>
          ...
          <div className="stat-card">
            ...
            <div className="stat-content">
              <div className="stat-value">{analytics.pending_comments || 0}</div>
          ...
          <div className="stat-card">
            ...
            <div className="stat-content">
              <div className="stat-value">{analytics.approval_rate || 0}%</div>
      ...
      <div className="section">
        ...
        <div className="share-stats">
          {analytics.share_stats?.map((stat) => (
            <div key={stat.platform} className="share-item">
              ...
              <div className="share-count">{adminReportsService.formatNumber(stat.count)}</div>
            </div>
          ))}
        </div>
      </div>
      ...
      {analytics.most_commented && analytics.most_commented.length > 0 && (
        <div className="section">
          ...
          <div className="articles-list">
            {analytics.most_commented.map((item, index) => (
              <div key={item.news.id} className="article-row">
                <div className="article-rank">#{index + 1}</div>
                <div className="article-info">
                  <div className="article-title">{item.news.title}</div>
